...
export const ANIMATION_LUMINANCE_TARGETS: readonly AnimationLuminanceTarget[] = [
  // SMILE — face outline readable at Ground; reduced halo in God
  {
    ...
    viewName: 'Horizon',
    pattern: 'smile',
    featureLuminance: 2.2,
    backgroundLuminance: 1.0,
    notes: 'Balanced emerge/glow phases',
  },
  {
    viewModeIndex: 1,
    viewName: 'God',
    pattern: 'smile',
    featureLuminance: 1.9,
    backgroundLuminance: 0.85,
    notes: 'Tight kernel + higher contrast resists bloom soup',
  },
  {
    viewModeIndex: 2,
    viewName: 'Fleet POV',
    pattern: 'smile',
    featureLuminance: 1.7,
    backgroundLuminance: 0.8,
    notes: 'Micro billboards; restrained hero tier',
  },
  {
    viewModeIndex: 3,
    viewName: 'Ground',
    pattern: 'smile',
    featureLuminance: 2.5,
    backgroundLuminance: 1.15,
    notes: 'Boosted intensity for sparse visible sats',
  },
  {
    viewModeIndex: 4,
    viewName: 'Moon',
    pattern: 'smile',
    featureLuminance: 2.4,
    backgroundLuminance: 1.05,
    notes: 'Distance attenuation compensated by profile',
  },
  {
    viewModeIndex: 5,
    viewName: 'Skyline',
    pattern: 'smile',
    featureLuminance: 2.1,
    backgroundLuminance: 0.95,
    notes: 'Moderate vs city window emissives',
  },
  ...
  // DIGITAL RAIN — Moon faint columns, Horizon medium
  {
    viewModeIndex: 0,
    viewName: 'Horizon',
    pattern: 'digital_rain',
    featureLuminance: 2.0,
    backgroundLuminance: 0.95,
    notes: 'Medium column brightness',
  },
  {
    viewModeIndex: 1,
    viewName: 'God',
    pattern: 'digital_rain',
    featureLuminance: 1.75,
    backgroundLuminance: 0.82,
    notes: 'Reduced trail bleed in clutter',
  },
  {
    viewModeIndex: 2,
    viewName: 'Fleet POV',
    pattern: 'digital_rain',
    featureLuminance: 1.65,
    backgroundLuminance: 0.78,
    notes: 'High bloom threshold headroom',
  },
  {
    viewModeIndex: 3,
    viewName: 'Ground',
    ...
    featureLuminance: 2.1,
    backgroundLuminance: 1.0,
    notes: 'Sparse sky — columns pop',
  },
  {
    viewModeIndex: 4,
    viewName: 'Moon',
    pattern: 'digital_rain',
    featureLuminance: 1.5,
    backgroundLuminance: 0.72,
    notes: 'Faint columns against earthshine',
  },
  {
    viewModeIndex: 5,
    viewName: 'Skyline',
    pattern: 'digital_rain',
    featureLuminance: 1.85,
    backgroundLuminance: 0.88,
    notes: 'Background rain behind city glow',
  },
  ...
  // HEARTBEAT — diastole visible under high bloom threshold (Fleet/God)
  {
    ...
    featureLuminance: 2.1,
    backgroundLuminance: 0.95,
    notes: 'Dual-beat pulse readable',
  },
  {
    viewModeIndex: 1,
    viewName: 'God',
    pattern: 'heartbeat',
    featureLuminance: 1.8,
    backgroundLuminance: 0.88,
    notes: 'Low contrast gamma lifts diastole floor',
  },
  {
    viewModeIndex: 2,
    viewName: 'Fleet POV',
    ...
    notes: 'Diastole floor preserved at bloom 1.65',
  },
  {
    viewModeIndex: 3,
    viewName: 'Ground',
    pattern: 'heartbeat',
    featureLuminance: 2.3,
    backgroundLuminance: 1.05,
    notes: 'Sparse constellation pulse',
  },
  {
    viewModeIndex: 4,
    viewName: 'Moon',
    ...
    notes: 'Ring-wide wave visible',
  },
  {
    viewModeIndex: 5,
    viewName: 'Skyline',
    pattern: 'heartbeat',
    featureLuminance: 1.95,
    backgroundLuminance: 0.9,
    notes: 'Moderate pulse vs emissives',
  },
] as const;
