...
export class App implements AppRuntime {
  ...
  tleRealCount = 0;
  enabledConstellations: ChipCatalogId[] = ['starlink'];
  constellationGroupCounts = new Map<number, number>();
  webglGroupIds: Uint32Array | null = null;
  webglGroupVisibility: boolean[] = [true, true, true, true, true];
  webglMultiGroupColorMode = false;
  lastVisibleCount = 0;
