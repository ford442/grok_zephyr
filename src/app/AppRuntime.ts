...
import type { FocusManager } from '@/camera/FocusManager.js';
import type { EarthAtmosphereRenderer } from '@/render/EarthAtmosphereRenderer.js';
...
export interface AppRuntime {
  ...
  tleRealCount: number;
  enabledConstellations: ChipCatalogId[];
  constellationGroupCounts: Map<number, number>;
  webglGroupIds: Uint32Array | null;
  webglGroupVisibility: boolean[];
  webglMultiGroupColorMode: boolean;
