...
export function createPipelines(context: WebGPUContext): Pipelines {
    ...
    return {
      ...
      autoExposureHistogram: device.createComputePipeline({
        ...
        compute: {
          module: context.createShaderModule(SHADERS.render.postProcess.autoExposureHistogram, 'auto-exposure-histogram'),
          entryPoint: 'main',
        },
      }),
      autoExposureAdapt: device.createComputePipeline({
        ...
        compute: {
          module: context.createShaderModule(SHADERS.render.postProcess.autoExposureAdapt, 'auto-exposure-adapt'),
          entryPoint: 'main',
        },
      }),
      ...
      bloomThreshold: device.createRenderPipeline({
        ...
        vertex: {
          module: context.createShaderModule(SHADERS.render.postProcess.bloomThreshold, 'bloom-threshold'),
          entryPoint: 'vs',
        },
        fragment: {
          module: context.createShaderModule(SHADERS.render.postProcess.bloomThreshold, 'bloom-threshold'),
      ...
      bloomDownsample: device.createRenderPipeline({
        layout: device.createPipelineLayout({ bindGroupLayouts: [bloomLayout] }),
        vertex: {
          module: context.createShaderModule(SHADERS.render.postProcess.bloomDownsample, 'bloom-downsample'),
          entryPoint: 'vs',
        },
        fragment: {
          module: context.createShaderModule(SHADERS.render.postProcess.bloomDownsample, 'bloom-downsample'),
      ...
      bloomUpsample: device.createRenderPipeline({
        layout: device.createPipelineLayout({ bindGroupLayouts: [bloomLayout] }),
        vertex: {
          module: context.createShaderModule(SHADERS.render.postProcess.bloomUpsample, 'bloom-upsample'),
          entryPoint: 'vs',
        },
        fragment: {
          module: context.createShaderModule(SHADERS.render.postProcess.bloomUpsample, 'bloom-upsample'),
      ...
      dofDownsample: device.createRenderPipeline({
        ...
        vertex: {
          module: context.createShaderModule(SHADERS.render.postProcess.dofDownsample, 'dof-downsample'),
          entryPoint: 'vs',
        },
        fragment: {
          module: context.createShaderModule(SHADERS.render.postProcess.dofDownsample, 'dof-downsample'),
      ...
      dofComposite: device.createRenderPipeline({
        ...
        vertex: {
          module: context.createShaderModule(SHADERS.render.postProcess.dofComposite, 'dof-composite'),
          entryPoint: 'vs',
        },
        fragment: {
          module: context.createShaderModule(SHADERS.render.postProcess.dofComposite, 'dof-composite'),
