 ...
 *    = 2pi / S = 2pi / 1024  0.006136 rad = 0.3516deg
 *
 * In-plane linear spacing at each shell:
 *   Shell 0 (340km, a=6711km): s = 6711  0.006136  41.18 km
 *   Shell 1 (550km, a=6921km): s = 6921  0.006136  42.47 km
 *   Shell 2 (1150km,a=7521km): s = 7521  0.006136  46.15 km
 *
 * Cross-plane RAAN separation:
 *   Omega = 2pi / P = 2pi / 1024  0.006136 rad = 0.3516deg
 *   At equator: x  a  sin(Omega)  a  Omega  same as in-plane
 *
 * Angular separation as seen from camera (r_cam = 7091 km):
 *   _apparent(d) = s / d   where d = range to satellite
 *
 *   Closest approach ranges:
 *     Shell 0: d_min = |7091 - 6711| = 380 km   = 41.18/380 = 0.1084 rad = 6.21deg
 *     Shell 1: d_min = |7091 - 6921| = 170 km   = 42.47/170 = 0.2498 rad = 14.31deg
 *     Shell 2: d_min = |7521 - 7091| = 430 km   = 46.15/430 = 0.1073 rad = 6.15deg
 *
 *   At typical range 2000 km:   42/2000 = 0.021 rad = 1.2deg
 *   At max render 14000 km:     42/14000 = 0.003 rad = 0.17deg
 *
 * =================================================================================
 ...
 *   m_sat  m_sun - 2.5  log10(A   / (pi  d^2))
 *   For 1m^2 panel, =0.5, at 500km: m  5.0
 *
 * PSF model: Gaussian core + power-law halo
 *   I(r) = I_core  exp(-r^2/(2^2)) + I_halo / (1 + (r/r_h)^2)^2
 *
 ...
 *   _bloom = 4.0 arcmin = 1.16e-3 rad
 *
 * Billboard world-space half-size:
 *   r_billboard = d  _bloom = d  1.16e-3
 *
 * Corrected formula (replaces the old 1200/dist heuristic):
 *   bsize = d  _bloom  brightness_scale
 ...
 * New formula: bsize = dist  _bloom  scale      distance-proportional, correct
 *
 ...
 *
 * Model: Gaussian core (=0.08) + Moffat halo (=2.5, r_h=0.15)
